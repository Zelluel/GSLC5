...
@section('content')
    ...
    @for($i=0;$i<count($cloth);$i++)
            ...
            <img src={{ $photo[$i] }} class="card-img-top mx-auto d-block" style="margin:20px; width:200px; height:200px;" alt="Card image cap">
            <div class="card-body" style="d-flex flex-column">
                ...
                <h5 class="card-text" style="text-align:center"> Stock : {{ $stok[$i] }}</h5>
                @if($stok[$i] > 0)
